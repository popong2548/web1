...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2025 at 05:13 AM
...
CREATE TABLE `users` (
  ...
  `role` varchar(50) NOT NULL DEFAULT 'customer' COMMENT 'เช่น customer, admin',
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `first_name`, `last_name`, `role`, `phone_number`, `created_at`, `updated_at`) VALUES
(1, 'admin@gmail.com', 'admin@gmail.com', '$2y$10$NLwZCxB.c7ewbS6UStGU0.kWyy8tgDUK2tlR27lhtKio/BQR7LHIS', 'New', 'User', 'admin', NULL, '2025-09-12 06:48:01', '2025-09-12 07:05:16'),
(3, 'GGWP@gmail.com', 'GGWP@gmail.com', '$2y$10$YXMHtEP2NnVUudo03/xmbOQts905IhuG7mTqlPQS5VUM0xxs5pZFO', 'New', 'User', 'customer', NULL, '2025-09-12 07:48:07', '2025-09-12 07:48:07'),
(4, 'grd@gamil.com', 'grd@gamil.com', '$2y$10$8TNfixm8WCzf1Ruw/yxMfegfY2rhpqPiMBtmOmroUh4HoD6Fdyvla', 'New', 'User', 'admin', NULL, '2025-09-12 09:01:23', '2025-09-12 19:13:02');
